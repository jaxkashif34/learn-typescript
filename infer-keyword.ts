(() => {
  ...
  // Question: what will be the value of U in the above example ?
  // Answer: U will be "I'm a string" infer is a keyword that is used to infer (andaza legana) the type of a generic type
